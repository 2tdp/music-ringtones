...
import com.remi.ringtones.audiocutter.ringtonemaker.freeringtone.databinding.FragHomeBinding
...
@AndroidEntryPoint
class HomeFrag : BaseFragment<FragHomeBinding>(FragHomeBinding::inflate) {
    ...
    override fun setUp() {
        ...
        adapterMusic.newInstance(requireContext(), true, object : ICallBackItem {
        ...
        lifecycleScope.launch {
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiStateAllMusic.collect {
                    when (it) {
                        is UiState.Success -> {
