package com.remi.ringtones.audiocutter.ringtonemaker.freeringtone.utils.designvector;
...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean isAutoMirrored() {
        if (mDelegateDrawable != null) return DrawableCompat.isAutoMirrored(mDelegateDrawable);
...
//        }
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) throws XmlPullParserException {
        ...
        final int mode = TypedArrayUtils.getNamedInt(a, parser, "tintMode", AndroidResources.styleable_VectorDrawable_tintMode, -1);
        ...
        state.mAutoMirrored = TypedArrayUtils.getNamedBoolean(a, parser, "autoMirrored", AndroidResources.styleable_VectorDrawable_autoMirrored, state.mAutoMirrored);

        pathRenderer.mViewportWidth = TypedArrayUtils.getNamedFloat(a, parser, "viewportWidth", AndroidResources.styleable_VectorDrawable_viewportWidth, pathRenderer.mViewportWidth);

        pathRenderer.mViewportHeight = TypedArrayUtils.getNamedFloat(a, parser, "viewportHeight", AndroidResources.styleable_VectorDrawable_viewportHeight, pathRenderer.mViewportHeight);
        ...
        pathRenderer.mBaseWidth = a.getDimension(AndroidResources.styleable_VectorDrawable_width, pathRenderer.mBaseWidth);
        pathRenderer.mBaseHeight = a.getDimension(AndroidResources.styleable_VectorDrawable_height, pathRenderer.mBaseHeight);
        ...
        final float alphaInFloat = TypedArrayUtils.getNamedFloat(a, parser, "alpha", AndroidResources.styleable_VectorDrawable_alpha, pathRenderer.getAlpha());
    ...
    private void printGroupTree(VGroup currentGroup, int level) {
        ...
        for (int i = 0; i < currentGroup.mChildren.size(); i++) {
            ...
            else ((VPath) child).printVPath(level + 1);
        }
    }
    ...
    public int getChangingConfigurations() {
        if (mDelegateDrawable != null) return mDelegateDrawable.getChangingConfigurations();
    ...
    public boolean setVisible(boolean visible, boolean restart) {
        if (mDelegateDrawable != null) return mDelegateDrawable.setVisible(visible, restart);
    ...
    private static class VPathRenderer {
        ...
        public VPathRenderer(VPathRenderer copy) {
            ...
            if (copy.mRootName != null) mVGTargetsMap.put(copy.mRootName, this);
        }
    ...
    public static class VGroup {
        ...
        public VGroup(VGroup copy, ArrayMap<String, Object> targetsMap) {
            ...
            mChangingConfigurations = copy.mChangingConfigurations;
            if (mGroupName != null) targetsMap.put(mGroupName, this);
            ...
            for (int i = 0; i < children.size(); i++) {
                ...
                if (copyChild instanceof VGroup) {
                    ...
                    else throw new IllegalStateException("Unknown object in the tree!");
        ...
        public void inflate(Resources res, AttributeSet attrs, Resources.Theme theme, XmlPullParser parser) {
            final TypedArray a = obtainAttributes(res, theme, attrs, AndroidResources.styleable_VectorDrawableGroup);
            updateStateFromTypedArray(a, parser);
            a.recycle();
        }
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            mRotate = TypedArrayUtils.getNamedFloat(a, parser, "rotation", AndroidResources.styleable_VectorDrawableGroup_rotation, mRotate);
            ...
            // This is added in API 11
            mScaleX = TypedArrayUtils.getNamedFloat(a, parser, "scaleX", AndroidResources.styleable_VectorDrawableGroup_scaleX, mScaleX);

            // This is added in API 11
            mScaleY = TypedArrayUtils.getNamedFloat(a, parser, "scaleY", AndroidResources.styleable_VectorDrawableGroup_scaleY, mScaleY);

            mTranslateX = TypedArrayUtils.getNamedFloat(a, parser, "translateX", AndroidResources.styleable_VectorDrawableGroup_translateX, mTranslateX);
            mTranslateY = TypedArrayUtils.getNamedFloat(a, parser, "translateY", AndroidResources.styleable_VectorDrawableGroup_translateY, mTranslateY);
    ...
    private static class VPath {
        ...
        public void setPathData(PathParser.PathDataNode[] nodes) {
            ...
            else PathParser.updateNodes(mNodes, nodes);
        }
    }
    ...
    private static class VClipPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Resources.Theme theme, XmlPullParser parser) {
            ...
            final TypedArray a = obtainAttributes(r, theme, attrs, AndroidResources.styleable_VectorDrawableClipPath);
    ...
    public static class VFullPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Resources.Theme theme, XmlPullParser parser) {
            final TypedArray a = obtainAttributes(r, theme, attrs, AndroidResources.styleable_VectorDrawablePath);
            updateStateFromTypedArray(a, parser);
            a.recycle();
        }
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            mFillColor = TypedArrayUtils.getNamedColor(a, parser, "fillColor", AndroidResources.styleable_VectorDrawablePath_fillColor, mFillColor);
            mFillAlpha = TypedArrayUtils.getNamedFloat(a, parser, "fillAlpha", AndroidResources.styleable_VectorDrawablePath_fillAlpha, mFillAlpha);
            final int lineCap = TypedArrayUtils.getNamedInt(a, parser, "strokeLineCap", AndroidResources.styleable_VectorDrawablePath_strokeLineCap, -1);
            mStrokeLineCap = getStrokeLineCap(lineCap, mStrokeLineCap);
            final int lineJoin = TypedArrayUtils.getNamedInt(a, parser, "strokeLineJoin", AndroidResources.styleable_VectorDrawablePath_strokeLineJoin, -1);
            mStrokeLineJoin = getStrokeLineJoin(lineJoin, mStrokeLineJoin);
            mStrokeMiterlimit = TypedArrayUtils.getNamedFloat(a, parser, "strokeMiterLimit", AndroidResources.styleable_VectorDrawablePath_strokeMiterLimit, mStrokeMiterlimit);
            mStrokeColor = TypedArrayUtils.getNamedColor(a, parser, "strokeColor", AndroidResources.styleable_VectorDrawablePath_strokeColor, mStrokeColor);
            mStrokeAlpha = TypedArrayUtils.getNamedFloat(a, parser, "strokeAlpha", AndroidResources.styleable_VectorDrawablePath_strokeAlpha, mStrokeAlpha);
            mStrokeWidth = TypedArrayUtils.getNamedFloat(a, parser, "strokeWidth", AndroidResources.styleable_VectorDrawablePath_strokeWidth, mStrokeWidth);
            mTrimPathEnd = TypedArrayUtils.getNamedFloat(a, parser, "trimPathEnd", AndroidResources.styleable_VectorDrawablePath_trimPathEnd, mTrimPathEnd);
            mTrimPathOffset = TypedArrayUtils.getNamedFloat(a, parser, "trimPathOffset", AndroidResources.styleable_VectorDrawablePath_trimPathOffset, mTrimPathOffset);
            mTrimPathStart = TypedArrayUtils.getNamedFloat(a, parser, "trimPathStart", AndroidResources.styleable_VectorDrawablePath_trimPathStart, mTrimPathStart);
        }
